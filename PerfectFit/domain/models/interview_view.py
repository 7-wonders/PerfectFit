...
class InterviewView(db.Model):
    __tablename__ = "interview_view"
    ...
    interview: Mapped["Interview"] = db.relationship("Interview", back_populates="interview_views")
    user: Mapped["AppUser"] = db.relationship("AppUser", back_populates="interview_views")
    company: Mapped["Company"] = db.relationship("Company", back_populates="interview_views")